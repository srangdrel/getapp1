                    ...
                    <div class="card card-info card-outline">
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                        <input type="button" class="btn btn-primary" value="  submit  " onclick="withoutCard1()">
                                        </div>
       ...
       success: function(response){
        if(response){
                   ...
                   // document.getElementById("Img").src = "https://gateway.rtc.bt/Photos/108574.jpg";
                    ...
                    var audio = new Audio('http://172.16.0.23/Gate/public/thnk.mp3');
                   audio.play(); 
                  }
